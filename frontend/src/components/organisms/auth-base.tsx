    ...
    return (
        <div className="relative flex items-center min-h-screen w-screen bg-gradient-to-b from-salmon-50 to bg-salmon-700/15 pl-12 overflow-hidden">
            ...
            <div className="absolute inset-0 -z-10">
                <circle className="border-4 border-salmon-900/10 w-[800px] h-[800px] rounded-full absolute bottom-1/2 left-10 z-0" />
                <circle className="border-2 border-salmon-950/10 w-[800px] h-[800px] rounded-full absolute bottom-1/2 left-10 z-0" />
